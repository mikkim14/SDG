...
if (isset($_POST['create'])) {
    $extension = $_POST['total_number_of_extensions_PPAs'];
    $title = $_POST['title_of_the_ppa'];
    $short_desc = $_POST['short_description_of_the_ppa'];
    $cost = $_POST['total_cost'];
    $fund = $_POST['fund_source'];

    if (empty($extension) || empty($title) || empty($short_desc) || !is_numeric($cost) || !empty($fund)) {
        ...
        $query = "INSERT INTO 12_6_1 (total_number_of_extensions_PPAs, title_of_the_ppa,short_description_of_the_ppa, total_cost, fund_source) VALUES ('$extension','$title', '$short_desc', '$cost', '$fund')";
...
if (isset($_POST['update'])) {
    ...
    if (empty($extension) || empty($title) || empty($short_desc) || !is_numeric($cost) || !empty($fund)) {
        ...
        $query = "INSERT INTO 12_6_1 (total_number_of_extensions_PPAs, title_of_the_ppa,short_description_of_the_ppa, total_cost, fund_source) VALUES ('$title', '$short_desc', '$cost', '$fund')";
        $add_research = mysqli_query($conn, $query);
...
if (isset($_POST['delete'])) {
    ...
    $query = "DELETE FROM 12_2_1 WHERE id='$id'";
...
<body background="backgroundf.avif">
    <div class="container">
        ...
        <div class="form-container">
            ...
            <div>
                    <label for="total_number_of_extensions_PPAs">Total number of extension PPAs related to responsible consumption and production:</label>
                    <input type="text" name="total_number_of_extensions_PPAs" id="total_number_of_extensions_PPAs" required>
                </div>
                <div>
        ...
        <div class="table-container">
            ...
            <table>
                <thead>
                    <tr>
                        <th>Total number of extension PPAs related to responsible consumption and production: </th>
                        <th>Title</th>
                ...
                <tbody>
                    <?php
                    $query = "SELECT * FROM 12_6_1";
                    $result = mysqli_query($conn, $query);

                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    <td>{$row['total_number_of_extensions_PPAs" id="total_number_of_extensions_PPAs']}</td>
                                    ...
                                    <td class='action-buttons'>
                                        <form action='' method='post' style='display:inline;'>
                                            ...
                                            <input type='hidden' name='total_number_of_extensions_PPAs' value='{$row['total_number_of_extensions_PPAs']}'>
        ...
        echo "<div class='container'>
                ...
                <div class='form-container'>
                    <form action='' method='post'>
                        ...
                        <div>
                            <label for='total_number_of_extensions_PPAs'>Total number of extension PPAs related to responsible consumption and production:</label>
                            <input type='text' name='total_number_of_extensions_PPAs' id='total_number_of_extensions_PPAs' value='$extension' required>
                        </div>
                        <div>
                            <label for='title_of_the_ppa'>Title:</label>
